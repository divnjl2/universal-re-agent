"""
Web3 wallet router — wallet creation, balance, swaps, staking, chains.

NOTE: This was originally in routers/web3.py but that file is shadowed by the
web3/ package directory.  Moved here so the endpoints are actually reachable.
"""
...
logger = logging.getLogger("app.routers.web3.wallet")
router = APIRouter()
