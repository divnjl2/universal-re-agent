"""
RECOVERED: bybit_manager.scripts.excel
...
class AbstractAsyncContextManager(object):
    """RECOVERED: AbstractAsyncContextManager from bybit_manager.scripts.excel"""
    pass

class AbstractContextManager(object):
    """RECOVERED: AbstractContextManager from bybit_manager.scripts.excel"""
    pass

class AsyncContextManager(object):
    """RECOVERED: AsyncContextManager from bybit_manager.scripts.excel"""
    async def asynccontextmanager(self):  # RECOVERED
        raise NotImplementedError


class AsyncContextManagerMixin(object):
    """RECOVERED: AsyncContextManagerMixin from bybit_manager.scripts.excel"""
    pass

class AsyncPingManager(object):
    """RECOVERED: AsyncPingManager from bybit_manager.scripts.excel"""
    pass

class AwaitableOrContextManager(object):
    """RECOVERED: AwaitableOrContextManager from bybit_manager.scripts.excel"""
    pass

class AwaitableOrContextManagerWrapper(object):
    """RECOVERED: AwaitableOrContextManagerWrapper from bybit_manager.scripts.excel"""
    pass

class BybitCardCommission(object):
    """RECOVERED: BybitCardCommission from bybit_manager.scripts.excel"""
    pass

class BybitClient(object):
    """RECOVERED: BybitClient from bybit_manager.scripts.excel"""
    pass

class BybitDevice(object):
    """RECOVERED: BybitDevice from bybit_manager.scripts.excel"""
    pass
