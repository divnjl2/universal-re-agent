"""
RECOVERED: bybit_manager.scripts._excel_columns
...
# === Constants ===
ADDRESS_COLUMNS = None  # RECOVERED
...
COLUMNS = None  # RECOVERED
DEFAULT_MANAGER_ATTR = None  # RECOVERED
ERROR_SPACES_NUMBER_OF_COLUMNS_INVALID = None  # RECOVERED

class AbstractAsyncContextManager(object):
    """RECOVERED: AbstractAsyncContextManager from bybit_manager.scripts._excel_columns"""
    pass

class AbstractContextManager(object):
    """RECOVERED: AbstractContextManager from bybit_manager.scripts._excel_columns"""
    pass

class AsyncContextManager(object):
    """RECOVERED: AsyncContextManager from bybit_manager.scripts._excel_columns"""
    async def asynccontextmanager(self):  # RECOVERED
        raise NotImplementedError


class AsyncContextManagerMixin(object):
    """RECOVERED: AsyncContextManagerMixin from bybit_manager.scripts._excel_columns"""
    pass

class AsyncPingManager(object):
    """RECOVERED: AsyncPingManager from bybit_manager.scripts._excel_columns"""
    pass

class AwaitableOrContextManager(object):
    """RECOVERED: AwaitableOrContextManager from bybit_manager.scripts._excel_columns"""
    pass

class AwaitableOrContextManagerWrapper(object):
    """RECOVERED: AwaitableOrContextManagerWrapper from bybit_manager.scripts._excel_columns"""
    pass

class BybitCardCommission(object):
    """RECOVERED: BybitCardCommission from bybit_manager.scripts._excel_columns"""
    pass

class BybitClient(object):
    """RECOVERED: BybitClient from bybit_manager.scripts._excel_columns"""
    pass

class BybitDevice(object):
    """RECOVERED: BybitDevice from bybit_manager.scripts._excel_columns"""
    pass
